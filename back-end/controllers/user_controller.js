...
exports.notification = function(req, res) {
  ...
  db.query(
    `SELECT cnt.noti, cnt.creation_date, cnt.threadid,cnt.forumid
    FROM(
      -- create new thread
    ...
    UNION ALL
    SELECT vp.noti, vp.creation_date, vp.threadid,vp.forumid
    FROM(
      -- vote post
    ...
    UNION ALL
    SELECT vc.noti, vc.creation_date, vc.threadid,vc.forumid
    FROM(
      -- vote comment
    ...
    UNION ALL 
    SELECT cnsf.noti, cnsf.creation_date, cnsf.threadid,cnsf.forumid
    FROM(
      -- creat new subforum
     ...
     UNION ALL 
     SELECT cvp.noti,cvp.creation_date, cvp.threadid,cvp.forumid
     FROM (
